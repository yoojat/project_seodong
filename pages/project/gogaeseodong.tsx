  ...
  return (
    <>
      ...
      <ContentContainer>
        ...
        <p className='my-1'>서동 지역의 활용가능한 자원들을 통해,</p>
        <p className='my-1'>
          멈춰진 동네에 사람들의 발길이 닿도록 하는 것을 목표로 하고있습니다.
        </p>
        <div className='h-3' />

        <p className='my-1'>또한, </p>
        <p className='my-1'>로컬 자원을 활용하여,</p>
        <p className='my-1'>쇠퇴되어가고 있는 지역 생태계에,</p>
        <p className='my-1'>조금이라도 보탬이 되는 것을 소망합니다.</p>
