  ...
  return (
    <>
      ...
      <ContentContainer>
        ...
        <p className='my-4'>그 모임이 커지고 활성화된다면</p>
        <p className='my-4'>
        ...
        <p className='my-4'>공간 고개서동은 쓸모없는 공간은 없다. </p>

        <p className='my-4'>모든 공간은 추억과 이야기가 있다는 마음으로 </p>

        <p className='my-4'>
          아무도 바라보지 않는 오래된 집을 재가공, 시공함으로써{' '}
        </p>
        <p className='my-4'>사람을 찾게 만드는 공간 업사이클링 입니다. </p>
        <p className='my-4'>1층_공유주방 (운영중) </p>
        <p className='my-4'>2층_파티룸 과 스튜디오 (운영중) </p>
        <p className='my-4'>3층_ 서재 (예정) </p>
        <p className='my-4'>4층_ 민박집 (예정) </p>
        <p className='my-4'>5층_ 옥상정원 (예정)</p>
        <p className='my-4'>이뤄질 예정입니다.</p>
      </ContentContainer>
    </>
  );
};
